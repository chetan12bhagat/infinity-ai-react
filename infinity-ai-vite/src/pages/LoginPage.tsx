...
const LoginPage: React.FC<LoginPageProps> = ({ onSwitchToSignUp, onNeedsVerify }) => {
    ...
    <div className="auth-container">
      ...
      <div className="auth-left">
        <div className="auth-left-content">
          ...
          <h1 className="auth-left-title">Infinity AI</h1>
          <p className="auth-left-subtitle">Join the infinite evolution of intelligence and creativity.</p>
      ...
      <div className="auth-right">
        <div className="auth-right-content">
          <h2 className="auth-title-large stagger-1">Welcome Back</h2>
          <p className="auth-subtitle-small stagger-1">Continue your infinite journey</p>
          ...
          <form className="stagger-3" onSubmit={handleSubmit}>
            ...
            <div className="auth-input-group">
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span className="auth-link-purple" style={{ fontSize: '12px' }} onClick={() => window.location.href = '/forgot-password'}>
                  Forgot Password?
                </span>
              </div>
          ...
          <p className="auth-footer-text stagger-4">
            ...
            <span className="auth-link-purple" onClick={onSwitchToSignUp}>Sign Up</span>
          </p>
        </div>
      </div>
    </div>
